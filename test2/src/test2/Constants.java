...
public class Constants {
    ...
    public static final int FOX_HUNGER_CYCLE = 50000; // Fox gets hungry every 20 seconds
    public static final int HUNTING_RANGE = 100; // Foxes hunt within 100px range
    ...
    public static final int FOX_DEATH_BY_HUNGER = 40000; // Fox dies if hungry for more than 40 seconds
    ...
    public static final int MATING_CYCLE = 25000;
